...
const Navbar = () => {
    ...
    return (
        <>
            ...
            {/* Mobile Navbar  */}
            <div className={`h-screen lg:hidden py-[9rem] transition-all duration-500 ease-in-out${showNavbar ? "flex translate-x-0 opacity-100" : "hidden translate-x-[40rem] opacity-75"} flex-col items-start justify-start fixed bg-black text-white z-[999] w-screen px-6`}>
                <ul className="flex flex-col items-start justify-center h-full gap-[4rem] text-5xl text-zinc-400">
                ...
                <button className="bg-[#bbfd03] hover:bg-[#ceff46] items-center justify-center transition-all text-black font-semibold text-xl h-16 w-auto px-7 rounded-xl">
                    Explore Now
                </button>
            </div>
        </>
